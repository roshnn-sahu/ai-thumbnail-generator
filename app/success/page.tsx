  ...
  return (
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="max-w-md w-full bg-neutral-900/50 backdrop-blur-xl border border-neutral-800 p-10 rounded-3xl text-center relative z-10 shadow-2xl"
      >
        <div className="inline-flex items-center justify-center p-4 bg-green-500/10 rounded-full mb-6">
          <CheckCircle2 className="w-12 h-12 text-green-500" />
        </div>

        <h1 className="text-4xl font-black mb-4 bg-gradient-to-br from-white to-neutral-500 bg-clip-text text-transparent">
          Welcome to the Club!
        </h1>
        
        <p className="text-neutral-400 mb-10 leading-relaxed">
          Your payment was successful and your account has been upgraded. You now have full access to premium features and more AI credits.
        </p>

        <div className="grid gap-4">
          <Button 
            onClick={() => router.push("/dashboard")}
            className="h-14 bg-white hover:bg-neutral-200 text-black font-bold rounded-2xl text-lg flex items-center justify-center gap-2 group transition-all"
          >
            Go to Dashboard
          ...
          <Button 
            variant="ghost"
            onClick={() => router.push("/")}
            className="h-14 text-neutral-400 hover:text-white hover:bg-neutral-800/50 rounded-2xl flex items-center justify-center gap-2"
          >
