...
const TrustBadge = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center my-4 select-none">
      <p className="mb-2 text-center text-sm text-neutral-500 lg:text-md dark:text-neutral-400">
        ...
        <div className="flex flex-row items-center">
          {testimonials.map((t, i) => (
            <div key={i} className="group relative -mr-4 shrink-0">
              <div className="relative size-10 overflow-hidden rounded-full border-2 border-white lg:size-10 dark:border-black">
                <Image
                  alt={t.name}
                  src={t.src}
                  fill
